 ...
 */
class Descripsion : Fragment() {

    private var head : String = ""
    private var body : String = ""
    private var img : String = ""

    fun newInstance(head: String,body: String,img: String): Descripsion {

        val fragment = Descripsion()
        val bundle = Bundle()
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_descripsion, container, false)
